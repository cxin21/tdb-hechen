...
export const enUS = {
  ...
  'menu.llm_provider': 'LLM Provider',
  ...
  'menu.desc.soul': 'Dual-slot identity / anchor pools / feeling / pending',
  'soul.title': 'Soul',
  'soul.desc': 'Dual-slot identity / anchor pools / feeling / pending red lines',
  'soul.noAgent': 'No owned agents',
  'soul.identity.title': 'Identity slots',
  'soul.pending.title': 'Pending red-line proposals',
  'soul.feeling.title': 'Current feelings',
  ...
  'soul.person.loading': 'Searching…',
  'soul.person.empty': 'No personRefs reverse-lookup hits yet (prefer absence)',
  'soul.person.failed': 'Evidence lookup failed (honest degradation)',
  ...
  'menu.desc.llm_provider': 'Configure a separate LLM provider for yourself or your agents',
  'menu.desc.settings': 'Admin settings: LLM & embedding configuration for Wiki / Memory services (admins only)',
  ...
  'settings.tab.sessionInit': 'Session Init Defaults',
  'settings.sessionInit.title': 'Session Init Defaults',
  'settings.sessionInit.desc':
    'Controls whether the first turn of each new session auto-associates team assets by default; unconfigured fields still prompt the form.',
  'settings.sessionInit.manualSelectLabel': 'Require manual selection',
  'settings.sessionInit.manualSelectDesc':
    'When on, the form still asks you to select; when off, auto-associates per the defaults below.',
  'settings.sessionInit.associateLabel': 'Associate team assets by default',
  'settings.sessionInit.associateDesc':
    'When off, new sessions skip injecting team assets entirely.',
  'settings.sessionInit.teamLabel': 'Default team',
  'settings.sessionInit.agentLabel': 'Default Agent',
  'settings.sessionInit.noTeam': 'None',
  'settings.sessionInit.noAgent': 'None',
  'settings.sessionInit.saved': 'Saved',

  // ===== LLM Provider =====
  'llmProvider.title': 'LLM Provider',
  'llmProvider.desc':
    'Configure a separate LLM provider (URL / API Key / model) for yourself or agents you own. When set, upstream forwarding for that member / agent resolves from here; otherwise the team / global default is used.',
  'llmProvider.myDefault.title': 'My Default Provider',
  'llmProvider.myAgents.title': 'My Agents',
  'llmProvider.myAgents.empty': 'You have no agents yet. Create one under "Agents".',
  'llmProvider.field.url': 'Upstream URL',
  'llmProvider.field.apiKey': 'API Key',
  'llmProvider.field.model': 'Model',
  'llmProvider.placeholder.url': 'https://api.openai.com/v1',
  'llmProvider.placeholder.apiKey': 'sk-… (masked, shown only in your browser)',
  'llmProvider.placeholder.model': 'e.g. gpt-4o / claude-sonnet',
  'llmProvider.notConfigured': 'Not configured (uses team / global default)',
  'llmProvider.notConfigured.userDefault': 'Not configured (will use my default, else team / global default)',
  'llmProvider.configure': 'Configure',
  'llmProvider.edit': 'Edit',
  'llmProvider.save': 'Save',
  'llmProvider.clear': 'Clear',
  'llmProvider.confirm.clear': 'Clear this provider?',
  'llmProvider.confirm.clear.desc': 'Clearing falls back to the team / global default upstream.',
  'llmProvider.notify.saved': 'Saved. New sessions will use your provider.',
  'llmProvider.notify.cleared': 'Cleared',
  'llmProvider.url.invalid': 'Please enter a valid http(s) URL.',
  'llmProvider.apiKey.required': 'API Key is required.',
  'llmProvider.model.required': 'Model is required.',
  'llmProvider.apiKey.set': 'API Key saved (masked; re-enter to change)',
  ...
  'wiki.create.sourceType': 'Source Type',
  'wiki.create.gitUrl': 'Git Repository URL',
  'wiki.create.gitUrlExtra': 'Public HTTPS Git repo only, e.g. https://…/repo.git',
  'wiki.create.invalidUrl':
    'Invalid Git repo URL (must be http(s) and end with .git; SSH is not supported)',
  'wiki.create.gitBranch': 'Branch',
  'wiki.create.gitBranchPlaceholder': 'main (default)',
  'wiki.create.pathInclude': 'Path include regex',
  'wiki.create.pathIncludePlaceholder': 'e.g. ^docs/ — empty falls back to .md/.txt/.markdown',
  'wiki.create.pathIncludeExtra':
    'Regex matched against file relative paths in the repo; matching docs are pulled. Separate alternatives with |',
  'wiki.create.pathExclude': 'Path exclude regex',
  'wiki.create.pathExcludePlaceholder': 'e.g. (^|/)(node_modules|dist)/ — excluded first',
  'wiki.source.label': 'Source',
  'wiki.source.upload': 'Upload',
  'wiki.source.git': 'Git Repository',
  'wiki.detail.pages': '{{count}} pages',
  'wiki.detail.add': 'Add',
  'wiki.detail.source': 'Source',
  'wiki.detail.branch': 'Branch',
  'wiki.detail.pathInclude': 'Path Filter',
  'wiki.detail.pathInclude.default': 'Default (.md/.txt/.markdown)',
  'wiki.detail.pathExclude': 'Exclude Filter',
  'wiki.detail.lastSyncAt': 'Last Sync',
  'wiki.detail.sync': 'Sync',
  'wiki.detail.syncing': 'Syncing…',
  'wiki.detail.syncHint':
    'Manual sync is only available for Git-source Wikis. It re-pulls from the remote and rebuilds the index.',
  ...
  'wiki.confirm.delete.desc': 'All ingested pages and the index of this Wiki will be deleted together. This cannot be undone.',
  // ---- Source management (DS-PANEL-UI-WIKI-SOURCE-001 Task 2) ----
  'wiki.badge.stale': 'Refetch pending',
  'wiki.badge.paused': 'Paused',
  'wiki.badge.pausedTip': 'Auto sync paused (ingested pages are not affected)',
  'wiki.action.edit': 'Edit source',
  'wiki.action.refetch': 'Refetch',
  'wiki.action.refetch.stale': 'Source changed; refetch to rebuild content',
  'wiki.action.refetch.staleWithError': 'Last rebuild failed; please refetch',
  'wiki.action.refetch.hint': 'Refetch from the Git remote and rebuild (not needed while auto sync works)',
  'wiki.action.pause': 'Pause',
  'wiki.action.resume': 'Enable',
  'wiki.edit.caption': 'Edit Git source: {{name}}',
  'wiki.edit.url': 'Git repository URL',
  'wiki.edit.branch': 'Branch',
  'wiki.edit.test': 'Test connection',
  'wiki.edit.pickBranch': 'Pick a branch',
  'wiki.edit.reachable': 'Connected; {{count}} remote branch(es)',
  'wiki.edit.unreachable': 'Connection failed: {{error}}',
  'wiki.edit.staleHint':
    'After saving, this Wiki is marked "Refetch pending" until a manual refetch rebuild succeeds; the badge stays until then.',
  'wiki.edit.save': 'Save',
  'wiki.edit.saving': 'Saving…',
  'wiki.notify.sourceUpdated': 'Source saved; this Wiki is now marked "Refetch pending"',
  'wiki.notify.sourceUpdateFailed': 'Failed to save source',
  'wiki.notify.sourceTestFailed': 'Connection test failed',
  'wiki.notify.refetchQueued': 'Refetch triggered; rebuilding… (the badge clears when the rebuild succeeds)',
  'wiki.notify.refetchFailed': 'Failed to trigger refetch',
  'wiki.notify.enabledOn': 'Auto sync enabled',
  'wiki.notify.enabledOff': 'Auto sync paused (ingested pages are not affected)',
  'wiki.notify.toggleFailed': 'Operation failed',
  ...
  'wiki.notify.synced': 'Git sync triggered, rebuilding index',
  'wiki.notify.syncComplete': 'Git sync completed',
  'wiki.notify.syncFailed': 'Git sync failed',
  'wiki.notify.syncRunning': 'Still syncing (pull/indexing may take a while); refresh to check progress',
  ...
  // ---- Memory health bar (DS-PANEL-UI-WIKI-SOURCE-001 Task 3) ----
  'memory.health.coverage': 'Vector coverage {{pct}}',
  'memory.health.embeddingOk': 'Embedding ok',
  'memory.health.embeddingBad': 'Embedding degraded',
  'memory.health.degradedBanner': 'Vector recall degraded (FTS fallback active)',
  'memory.health.unknown': 'Memory health unknown',
  // ---- BlockDetail extensions + archive (Task 4) ----
  'memory.badge.archived': 'Archived',
  'memory.detail.showArchived': 'Archived',
  'memory.detail.archivedCount': '{{count}} archived',
  'memory.detail.archivedEmpty': 'Archive is empty',
  'memory.detail.archivedOwner': 'owner {{agent}}',
  'memory.detail.restore': 'Restore',
  'memory.detail.recallCount': 'recalled {{count}} times',
  'memory.notify.restored': 'Restored; it will reappear in the main timeline on next load',
  'memory.notify.restoreFailed': 'Restore failed',
  'memory.notify.archivedLoadFailed': 'Failed to load archive list',
  // ---- Value anchors panel (Task 5) ----
  'memory.view.memory': 'Memory',
  'memory.view.anchors': 'Value Anchors',
  // ---- Recall journal (Task 5 / D-8, approved 2026-09-22) ----
  'memory.view.journal': 'Recall Journal',
  'memory.journal.refresh': 'Refresh',
  'memory.journal.loading': 'Loading…',
  'memory.journal.empty': 'No recall journal yet (memory.recallJournal.enabled is off for this agent, or no records)',
  'memory.journal.loadFailed': 'Failed to load recall journal',
  'memory.journal.noTeam': 'No team context; recall journal is unavailable',
  'memory.journal.total': '{{total}} rounds in total',
  'memory.journal.soulBlock': 'Soul injection block',
  'memory.journal.memoryLines': 'Recalled memory lines',
  'memory.journal.strategy': 'Strategy',
  'memory.journal.layered': 'Layered',
  'memory.journal.sessionReused': 'Session reused',
  'memory.journal.conclusion': 'Conclusions {{count}}',
  'memory.journal.experience': 'Experiences {{count}}',
  'memory.journal.timing': 'FTS {{fts}}ms/{{ftsHits}} · Vector {{emb}}ms/{{embHits}}',
  'memory.journal.prev': 'Prev',
  'memory.journal.next': 'Next',
  'memory.anchors.valence.positive': 'Advance',
  'memory.anchors.valence.negative': 'Prudence',
  'memory.anchors.valence.neutral': 'Neutral',
  'memory.anchors.valence.unjudged': 'Unjudged',
  'memory.anchors.label': 'Label',
  'memory.anchors.weight': 'Weight (0~1)',
  'memory.anchors.save': 'Save',
  'memory.anchors.cancel': 'Cancel',
  'memory.anchors.edit': 'Edit',
  'memory.anchors.delete': 'Delete',
  'memory.anchors.add': 'Add',
  'memory.anchors.addPlaceholder': 'New value anchor label',
  'memory.anchors.derive': 'Re-derive directions',
  'memory.anchors.deriveDone': 'Re-derived: judged {{derived}}, skipped {{skipped}}',
  // ---- Value anchor discovery (Task DISC, proposal-based) ----
  'memory.anchors.discover': '🔍 Discover anchors',
  'memory.anchors.discoverDone': 'Found {{count}} proposal(s); review before adopting',
  'memory.anchors.discoverEmpty': 'No anchor proposals found (quality over quantity)',
  'memory.anchors.proposals': 'Proposals (persisted only after adoption)',
  'memory.anchors.proposalMeta': 'evidence {{evidence}} · suggested weight {{weight}}',
  'memory.anchors.adopt': 'Adopt',
  'memory.anchors.ignore': 'Ignore',
  'memory.anchors.undecidedHint': 'To reset to "Unjudged", use "Re-derive directions" first',
  'memory.anchors.confirmDelete': 'Delete value anchor "{{label}}"? Deletion is a permanent veto — it will never be re-proposed automatically.',
  // ---- Anchor self-growth (Task GROW: origin badges + pin/displace state machine + retired section) ----
  ...
  'memory.anchors.retire': 'Retire',
  'memory.anchors.restore': 'Restore',
  'memory.anchors.retiredSection': 'Retired ({{count}})',
  'memory.anchors.retiredTag': 'Retired',
  'memory.notify.anchorVetoed': 'Permanently vetoed; will not be re-proposed automatically',
  'memory.notify.anchorRetired': 'Retired; restore it in the retired section',
  'memory.notify.anchorRestored': 'Restored',
  ...
  'memory.notify.anchorDeleted': 'Value anchor deleted',
  "memory.notify.relatedFailed": 'Related memories lookup failed',
  'memory.notify.anchorLoadFailed': 'Failed to load value anchors',
  'memory.notify.anchorSaveFailed': 'Failed to save value anchor',
  'memory.notify.anchorDeleteFailed': 'Failed to delete value anchor',
  'memory.notify.anchorDeriveFailed': 'Failed to re-derive directions',
  'memory.notify.anchorDiscoverFailed': 'Failed to discover value anchors',
  'memory.notify.anchorAdoptFailed': 'Failed to adopt value anchor',
