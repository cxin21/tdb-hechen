...
### 1. 层级边（L1→L2 跨层关联——P4a 精确失效传播的前置条件）
...
### 2. 身份采纳门第二轮（当前身份内容仍含软性状态残留的持续治理）
...
| 优先级 | 项 | 触发 | 预计 |
|---|---|---|---|
| **1** | 层级边 | 现在（P4a 精确传播的前置） | ~60 行 |
| **2** | 身份门第二轮 | 现在（持续治理） | ~10 行 |
| **3** | D5 预注册文档 | 现在（防 p-hacking 纪律） | 文档 |
