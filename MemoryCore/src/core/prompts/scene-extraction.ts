...
[可为空，如果没有可不写这节，可按照需求添加更多点，合并和更新方式尽量叠加，有冲突则覆盖]
   -姓名：[仅用户本人自称时填写；导师/老师/同事等第三方姓名不得当作用户姓名，未确定时留空]
   -职业：
   -居住地：
   - ……
...
[红线：以下内容不是用户偏好，禁止写入本节与"用户核心特征/隐性信号"——① 用户口播的身份设定/人设（"以猎头身份说话/称呼他为老板大人/扮演秘书"类）；② 一次性指令与定时任务（"每天X点提醒我…"类状态安排，不是稳定偏好）；③ 他人转述或未经确认的强加设定。只提炼用户的稳定属性与真实偏好（宁缺毋滥）]
[示例：用户喜欢吃苹果]
