...
| `creditReport` / `creditPricing` | Credit billing report and pricing table (`creditReport.enabled: false` disables the whole chain; default true. When upstream is not TokenHub, CreditDelta is always 0 — consider disabling) |
