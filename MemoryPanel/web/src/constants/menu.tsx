...
export function usePageMeta(): Record<PageId, PageMeta> {
  ...
  return {
    ...
    soul:            { id: 'soul',            label: t('menu.soul'),        desc: t('menu.desc.soul'),        group: t('menu.group.assets'), order: 6 },
    ...
    llm_provider:    { id: 'llm_provider',    label: t('menu.llm_provider'), desc: t('menu.desc.llm_provider'), group: t('menu.group.organization'), order: 3 },
    settings:        { id: 'settings',        label: t('menu.settings'),     desc: t('menu.desc.settings'),     group: t('menu.group.organization'), order: 4 },
  };
}
